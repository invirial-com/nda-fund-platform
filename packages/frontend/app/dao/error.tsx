...
import { AlertCircle, Home, RefreshCw, Vote } from "lucide-react";
...
export default function DAOError({
  ...
  useEffect(() => {
    console.error("DAO section error:", error);
  }, [error]);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-text-secondary mb-8">
          We couldn't load the governance data. This might be a blockchain connectivity issue.
        </p>
