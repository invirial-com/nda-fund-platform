 ...
 * Allows users to optionally tip NdaFundPlatform services
 */
  ...
  return (
    <div>
      <h3 className="text-lg sm:text-xl font-semibold mb-2">
        Tip NdaFundPlatform Services
      </h3>
      <p className="text-foreground/80 text-sm sm:text-base leading-6 mb-3">
        NdaFundPlatform has a 0% platform fee for organisers. NdaFundPlatform will continue
      ...
      <div className="relative pt-14 pb-4">
        ...
        <div className="relative h-2 bg-border-default rounded-full">
          ...
          <input
            ...
            aria-label="Tip percentage for NdaFundPlatform services"
          />
        </div>
