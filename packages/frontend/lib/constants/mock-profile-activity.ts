...
export const MOCK_POSTS: MockPost[] = [
  {
    id: "post-1",
    content:
      "Just donated to an amazing campaign helping children get access to clean water! Every little bit helps. 💧 #NdaFundPlatform #CleanWater",
    imageUrl:
...
export const MOCK_LIKES: MockLike[] = [
  {
    id: "like-1",
    content:
      "Just reached our $20,000 milestone for Tech Education! 🎉 Thank you to everyone who believed in our mission. Together, we're changing lives through code. #NdaFundPlatform #TechForGood",
    imageUrl:
  ...
  },
  {
    id: "like-4",
    content:
      "Solar panels installed in 3 more villages this week! ☀️ 200+ homes now have clean energy. The impact is real and it's growing every day. Thank you @NdaFundPlatform community!",
    imageUrl:
  ...
  },
  {
    id: "like-5",
    content:
      "Every child deserves access to clean water. Today, we completed our 10th well in rural Kenya. 🚰 This wouldn't be possible without your support. #CleanWater #NdaFundPlatform",
    author: {
      name: "John Smith",
      username: "johnsmith",
      avatar:
