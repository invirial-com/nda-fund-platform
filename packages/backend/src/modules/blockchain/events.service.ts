...
export class EventsService {
  ...
  async processEvent(
    ...
    try {
      ...
      switch (contractName) {
        ...
        case ContractName.NDA_FUND_PLATFROM_TOKEN:
  ...
  // ==================== NdaFundPlatformToken Event Processing ====================
  ...
  private async processFBTEvent(
    ...
    const iface = new ethers.Interface(NDA_FUND_PLATFROM_TOKEN_ABI);
    const parsedLog = iface.parseLog(eventData);
    ...
    switch (eventName) {
      case NdaFundPlatformTokenEvent.VESTING_SCHEDULE_CREATED:
      ...
      case NdaFundPlatformTokenEvent.VESTED_TOKENS_CLAIMED:
      ...
      case NdaFundPlatformTokenEvent.TOKENS_BURNED:
      ...
      default:
        this.logger.warn(`Unknown NdaFundPlatformToken event: ${eventName}`);
    }
  }
...
const NDA_FUND_PLATFROM_TOKEN_ABI = [
