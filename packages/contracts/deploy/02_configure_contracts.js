...
module.exports = async ({ getNamedAccounts, deployments, network }) => {
  ...
  const bridge = await ethers.getContractAt(
    "NdaFundPlatformBridge",
    (await get("NdaFundPlatformBridge")).address
  );
  ...
  // --- 1. Configure NdaFundPlatformBridge ---
  log("Configuring NdaFundPlatformBridge chains...");
  ...
  log("Configuring NdaFundPlatformBridge tokens...");
