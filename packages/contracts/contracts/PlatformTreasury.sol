...
/**
 * @title INdaFundPlatformToken
 * @notice Interface for the FBT governance token
 */
interface INdaFundPlatformToken is IERC20 {
    ...
    UUPSUpgradeable
{
    ...
    INdaFundPlatformToken public FBT;
     ...
     * @param _fbt NdaFundPlatform Token address
    ...
    function initialize(
        ...
        FBT = INdaFundPlatformToken(_fbt);
