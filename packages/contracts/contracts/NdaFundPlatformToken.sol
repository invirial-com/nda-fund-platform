...
/**
 * @title NdaFundPlatformToken
 * @author NdaFundPlatform Team
 * @notice FBT is the governance and rewards token for the NdaFundPlatform platform
 ...
 */
contract NdaFundPlatformToken is
    Initializable,
    ERC20Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    /**
     * @notice Initializes the NdaFundPlatformToken contract
    ...
    function initialize(address initialOwner) external initializer {
        ...
        __ERC20_init("NdaFundPlatform Token", "FBT");
        __ERC20Permit_init("NdaFundPlatform Token");
