# NdaFundPlatform Smart Contract Tests

## Overview

This directory contains comprehensive test suites for all mainnet-ready features in the NdaFundPlatform smart contracts. Tests are organized by feature and contract, with a focus on security, edge cases, and complete coverage.
...
### 2. NdaFundPlatformBridge.pause.test.js
...
**Run**: `npm test -- NdaFundPlatformBridge.pause.test.js`
...
### 5. NdaFundPlatformTimelock.test.js
...
**Run**: `npm test -- NdaFundPlatformTimelock.test.js`
